...
class Registration(db.Model):
    ...
    @classmethod
    def create(
        cls, event_id, ticket_type_id, attendee_id, payment_status, special_requests
    ):
        ...
        if ticket_type is None:
            raise ValueError(
                "Cannot register. The specifed ticket type does not exist."
            )
        ...
        if attendee is None:
            raise ValueError(
                "Cannot register. The specified attendee id does not exist."
    ...
    def approve(self):
        ...
        if not event.has_available_capacity():
            raise ValueError(
                "Cannot approve this registration. "
