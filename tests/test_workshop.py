...
class TestWorkshop:
    ...
    def test_workshop_session_outside_event_time_raises_value_error(
        self, seed_workshop_event_type, seed_organiser
    ):
        """
    ...
    def test_workshop_manual_approval_overbooking_raises_value_error(
        self, seed_workshop_event_type, seed_organiser
    ):
        """
        ...
        user_one_registration = Registration.create(
            event_id=workshop.id,
        ...
        user_two_registration = Registration.create(
            event_id=workshop.id,
            ticket_type_id=ticket.id,
    ...
    def test_speaker_session_changes_deletes_presentation_materials(
        self, seed_workshop_event_type, seed_organiser
    ):
        """
        ...
        presentation_material = PresentationMaterial.create(
            speaker_id=speaker.id, session_id=session.id, file_path="html.ppt"
        )
